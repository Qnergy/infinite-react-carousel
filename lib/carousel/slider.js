...
var Slider = /*#__PURE__*/function (_Component) {
  function Slider(props) {
    ...
    _defineProperty(_this, "isMounted", true);
    /**
     * settings init
     */
    _defineProperty(_this, "init", function () {
      ...
      settings = _objectSpread(_objectSpread({}, _types.defaultProps), _this.props);
     ...
     */
    _defineProperty(_this, "autoPlayInit", function () {
      var settings = _this.state.settings;
     ...
     */
    _defineProperty(_this, "connectObserver", function () {
     ...
     */
    _defineProperty(_this, "disconnectObserver", function () {
      if (_this.resizeObserver) {
     ...
     */
    _defineProperty(_this, "track", function () {
      var now = Date.now();
     ...
     */
    _defineProperty(_this, "autoScroll", function (type) {
      var settings = _this.state.settings;
      if (_this.amplitude) {
    ...
    _defineProperty(_this, "getItem", function (scrollItem, index) {
      var virtualList = _this.state.settings.virtualList;
      var el;
      if (virtualList) {
     ...
     * @param {Number} x
     */
    _defineProperty(_this, "scroll", function (type, x) {
      ...
      var centerMode = settings.centerMode,
        ...
        virtualList = settings.virtualList;
      // Start actual scroll
      var i;
      var el;
      ...
      var _this$scrollType = _this.scrollType,
        ...
        direction = _this$scrollType.direction;
      ...
      if (!_this.beforeChangeTrigger && type !== 'start' && type !== 'end' && type !== 'init') {
        ...
        var newIndex = _this.items.getIndex(activeIndex - dir);
        switch (scrollType) {
          case 'arrows':
            {
      ...
      if (typeof _this.oneTimeCallback === 'function') {
        _this.oneTimeCallback.call(_this, currItem, _this.dragged);
     ...
     */
    _defineProperty(_this, "updateItemStyle", function (el, transform) {
      var newEl = el;
      newEl.style[_this.xform] = transform;
      newEl.style.zIndex = 1;
      newEl.style.display = '';
    });
    _defineProperty(_this, "widthInit", function () {
     ...
     */
    _defineProperty(_this, "slideInit", function () {
     ...
     * @param {Event} e
     */
    _defineProperty(_this, "xpos", function (e) {
      // touch event
     ...
     * @param {Event} e
     */
    _defineProperty(_this, "ypos", function (e) {
      // touch event
      if (e.targetTouches && e.targetTouches.length >= 1) {
     ...
     * @param {Number} x
     */
    _defineProperty(_this, "wrap", function (x) {
     ...
     */
    _defineProperty(_this, "cycleTo", function (n, callback) {
     ...
     * @param {Number} n
     */
    _defineProperty(_this, "slickNext", function (n) {
     ...
     * @param {Number} n
     */
    _defineProperty(_this, "slickPrev", function (n) {
      if (_this.scrollType.type === 'arrows') {
        _this.doubleTrigger = true;
      }
      if (typeof n === 'number') {
     ...
     * @param {Function} callback
     */
    _defineProperty(_this, "slickSet", function (n, callback) {
      return _this.cycleTo(n, callback);
    });
    _defineProperty(_this, "createVirtualList", function () {
    ...
    _this.slideInit = _this.slideInit.bind(_this);
    _this.slickNext = _this.slickNext.bind(_this);
    _this.slickPrev = _this.slickPrev.bind(_this);
    _this.slickSet = _this.slickSet.bind(_this);
    _this.cycleTo = _this.cycleTo.bind(_this);
    _this.autoPlay = _this.autoPlay.bind(_this);
    _this.handleCarouselTap = _listener.handleCarouselTap.bind(_this);
    _this.signupListener = _listener.signupListener.bind(_this);
    _this.removeListener = _listener.removeListener.bind(_this);
    _this.handleCarouselDrag = _listener.handleCarouselDrag.bind(_this);
    _this.handleCarouselRelease = _listener.handleCarouselRelease.bind(_this);
    _this.handleAutoplayPause = _listener.handleAutoplayPause.bind(_this);
    _this.handleResize = (0, _throttle["default"])(_listener.handleResize.bind(_this), 1000, {
      leading: true
    });
    _this.handleResizeHeight = (0, _throttle["default"])(_listener.handleResizeHeight.bind(_this), 500);
    _this.handleVisibilityChange = _listener.handleVisibilityChange.bind(_this);
    _this.handleKeyDown = _listener.handleKeyDown.bind(_this);
    _this.handleClick = _listener.handleClick.bind(_this);
    _this.handleWheel = _listener.handleWheel.bind(_this);
    return _this;
  }
